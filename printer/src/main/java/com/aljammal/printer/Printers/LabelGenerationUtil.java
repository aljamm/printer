...
import com.ganesh.iarabic.arabicUTF;

import java.util.ArrayList;
import java.util.List;

public class LabelGenerationUtil {
    private static arabicUTF dplArabic = new arabicUTF();
    ...
    public static byte[] GenerateShelfTagLabelHoneywell_RP4(PrintData printData) {
        ...
        try {
            ...
            shelfTagLabel = "\u0002n\r\n" +
                    ...
                    dplArabic.Convert(printData.getName(), false, arabicUTF.a.c) + "\r\n" + // name as Ar
